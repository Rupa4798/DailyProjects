...
public class EmployeeController {
	...
	public Optional<Employee> findEmployee(@PathVariable int id) throws ResourceNotFound{
		Optional<Employee> optionalEmployee =service.findEmp(id);
		
			optionalEmployee.orElseThrow(()-> new ResourceNotFound("Employee not found "+id));
